...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 81077.0, "minX": 0.0, "maxY": 81077.0, "series": [{"data": [[0.0, 81077.0]], "isOverall": false, "label": "GET /api/baseline/grades", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var syntheticResponseTimeDistributionInfos = {
        data: {"result": {"minY": 81077.0, "minX": 0.0, "ticks": [[0, "Requests having \nresponse time <= 500ms"], [1, "Requests having \nresponse time > 500ms and <= 1,500ms"], [2, "Requests having \nresponse time > 1,500ms"], [3, "Requests in error"]], "maxY": 81077.0, "series": [{"data": [[0.0, 81077.0]], "color": "#9ACD32", "isOverall": false, "label": "Requests having \nresponse time <= 500ms", "isController": false}, {"data": [], "color": "yellow", "isOverall": false, "label": "Requests having \nresponse time > 500ms and <= 1,500ms", "isController": false}, {"data": [], "color": "orange", "isOverall": false, "label": "Requests having \nresponse time > 1,500ms", "isController": false}, {"data": [], "color": "#FF6347", "isOverall": false, "label": "Requests in error", "isController": false}], "supportsControllersDiscrimination": false, "maxX": 4.9E-324, "title": "Synthetic Response Times Distribution"}},
        getOptions: function() {
            return {
                legend: {
                    noColumns: 2,
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 7.359309071729974, "minX": 1.78231818E12, "maxY": 9.999414910263566, "series": [{"data": [[1.78231818E12, 7.359309071729974], [1.78231824E12, 9.999414910263566]], "isOverall": false, "label": "Utilizatori concurenti", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78231824E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.8267326732673266, "minX": 1.0, "maxY": 7.454999999999997, "series": [{"data": [[1.0, 1.8267326732673266], [2.0, 2.39378238341969], [4.0, 3.6427221172022697], [8.0, 7.430711610486892], [9.0, 7.454999999999997], [5.0, 4.270833333333334], [10.0, 7.2077606797446885], [3.0, 2.8938775510204087], [6.0, 5.051457975986274], [7.0, 6.194642857142852]], "isOverall": false, "label": "GET /api/baseline/grades", "isController": false}, {"data": [[9.752457540362922, 7.082033129000837]], "isOverall": false, "label": "GET /api/baseline/grades-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 10.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 33748.8, "minX": 1.78231818E12, "maxY": 472804.9666666667, "series": [{"data": [[1.78231818E12, 33748.8], [1.78231824E12, 327043.85]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78231818E12, 48790.4], [1.78231824E12, 472804.9666666667]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78231824E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 6.263317510548513, "minX": 1.78231818E12, "maxY": 7.1665192603376555, "series": [{"data": [[1.78231818E12, 6.263317510548513], [1.78231824E12, 7.1665192603376555]], "isOverall": false, "label": "GET /api/baseline/grades", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78231824E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 6.2588343881856545, "minX": 1.78231818E12, "maxY": 7.165566788673838, "series": [{"data": [[1.78231818E12, 6.2588343881856545], [1.78231824E12, 7.165566788673838]], "isOverall": false, "label": "GET /api/baseline/grades", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78231824E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.78231818E12, "maxY": 0.0023734177215190065, "series": [{"data": [[1.78231818E12, 0.0023734177215190065], [1.78231824E12, 0.0]], "isOverall": false, "label": "GET /api/baseline/grades", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78231824E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 670.0, "maxY": 8.0, "series": [{"data": [[670.0, 2.0], [1027.0, 3.0], [1079.0, 7.0], [1135.0, 8.0], [1159.0, 5.0], [1238.0, 7.0], [1276.0, 7.0], [1266.0, 7.0], [1285.0, 7.0], [1325.0, 7.0], [1287.0, 7.0], [1357.0, 7.0], [1360.0, 7.0], [1359.0, 7.0], [1392.0, 7.0], [1397.0, 7.0], [1393.0, 7.0], [1345.0, 7.0], [1366.0, 7.0], [1375.0, 7.0], [1370.0, 7.0], [1379.0, 7.0], [1407.0, 6.0], [1406.0, 6.0], [1401.0, 6.0], [1402.0, 7.0], [1384.0, 7.0], [1383.0, 7.0], [1388.0, 7.0], [1400.0, 7.0], [1363.0, 7.0], [1424.0, 6.0], [1420.0, 6.0], [1415.0, 6.0], [1419.0, 6.0], [1414.0, 6.0], [1416.0, 6.0], [1411.0, 6.0], [1410.0, 6.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1424.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 670.0, "maxY": 8.0, "series": [{"data": [[670.0, 2.0], [1027.0, 3.0], [1079.0, 7.0], [1135.0, 8.0], [1159.0, 5.0], [1238.0, 7.0], [1276.0, 7.0], [1266.0, 7.0], [1285.0, 7.0], [1325.0, 7.0], [1287.0, 7.0], [1357.0, 7.0], [1360.0, 7.0], [1359.0, 7.0], [1392.0, 7.0], [1397.0, 7.0], [1393.0, 7.0], [1345.0, 7.0], [1366.0, 7.0], [1375.0, 7.0], [1370.0, 7.0], [1379.0, 7.0], [1407.0, 6.0], [1406.0, 6.0], [1401.0, 6.0], [1402.0, 7.0], [1384.0, 7.0], [1383.0, 7.0], [1388.0, 7.0], [1400.0, 7.0], [1363.0, 7.0], [1424.0, 6.0], [1420.0, 6.0], [1415.0, 6.0], [1419.0, 6.0], [1414.0, 6.0], [1416.0, 6.0], [1411.0, 6.0], [1410.0, 6.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1424.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 126.56666666666666, "minX": 1.78231818E12, "maxY": 1224.7166666666667, "series": [{"data": [[1.78231818E12, 126.56666666666666], [1.78231824E12, 1224.7166666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78231824E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 126.4, "minX": 1.78231818E12, "maxY": 1224.8833333333334, "series": [{"data": [[1.78231818E12, 126.4], [1.78231824E12, 1224.8833333333334]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78231824E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 126.4, "minX": 1.78231818E12, "maxY": 1224.8833333333334, "series": [{"data": [[1.78231818E12, 126.4], [1.78231824E12, 1224.8833333333334]], "isOverall": false, "label": "GET /api/baseline/grades-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78231824E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 126.4, "minX": 1.78231818E12, "maxY": 1224.8833333333334, "series": [{"data": [[1.78231818E12, 126.4], [1.78231824E12, 1224.8833333333334]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78231824E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
